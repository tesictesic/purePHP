...
<body>
			...
			<div class="inner-sec-shop px-lg-4 px-3">
				...
				<div class="row">
					<div class="col-md-12 middle-slider my-4">
						<div class="middle-text-info d-flex justify-content-center align-items-center">
	...
	?>
	<!-- //footer -->
	<!-- js file --><script src="https://code.jquery.com/jquery-3.6.3.js" integrity="sha256-nQLuAZGRRcILA+6dMBOvcRh5Pe310sBpanc6+QBmyVM=" crossorigin="anonymous"></script>
